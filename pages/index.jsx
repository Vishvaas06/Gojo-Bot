...
const router = useRouter();
  ...
  <a className={" px-6 justify-center gap-x-2 shadow-lg shadow-amber-600/20 rounded-xl py-4 font-medium bg-gradient-to-bl from-yellow-700 to-gold-500 hover:opacity-80 transition duration-200 text-white " }>
Vote</a>
  </Link>
        </div>
